package com.example.edmund.splashactivity;
...
public class SplashActivity extends Activity {
    ...
    private void startAnimating() {
        ...
        Animation fade1 = AnimationUtils.loadAnimation(this, R.animation.fade_in);
        logo1.startAnimation(fade1);
        // Fade in bottom title after a built-in delay.
        TextView logo2 = (TextView) findViewById(R.id.TextViewBottomTitle);
        Animation fade2 = AnimationUtils.loadAnimation(this, R.animation.fade_in2);
